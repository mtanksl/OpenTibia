        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            if (EF.IsDesignTime)
            {
                ...
                modelBuilder.Entity<DbPlayer>().HasData(
                    ...
                    new DbPlayer() { Id = 2, AccountId = 1, WorldId = 1, Name = "Knight", Health = 1565, MaxHealth = 1565, Direction = 2, BaseOutfitId = 131, OutfitId = 131, BaseSpeed = 418, Speed = 418, SkillMagicLevel = 4, SkillFist = 10, SkillClub = 10, SkillSword = 90, SkillAxe = 10, SkillDistance = 10, SkillShield = 80, SkillFish = 10, Experience = 15694800, Level = 100, Mana = 550, MaxMana = 550, Soul = 100, Capacity = 139000, Stamina = 2520, Vocation = 1, SpawnX = 921, SpawnY = 771, SpawnZ = 6, TownX = 921, TownY = 771, TownZ = 6 },
                    new DbPlayer() { Id = 3, AccountId = 1, WorldId = 1, Name = "Paladin", Health = 1105, MaxHealth = 1105, Direction = 2, BaseOutfitId = 129, OutfitId = 129, BaseSpeed = 418, Speed = 418, SkillMagicLevel = 15, SkillFist = 10, SkillClub = 10, SkillSword = 10, SkillAxe = 10, SkillDistance = 70, SkillShield = 40, SkillFish = 10, Experience = 15694800, Level = 100, Mana = 1470, MaxMana = 1470, Soul = 100, Capacity = 139000, Stamina = 2520, Vocation = 2, SpawnX = 921, SpawnY = 771, SpawnZ = 6, TownX = 921, TownY = 771, TownZ = 6 },
                    new DbPlayer() { Id = 4, AccountId = 1, WorldId = 1, Name = "Sorcerer", Health = 645, MaxHealth = 645, Direction = 2, BaseOutfitId = 130, OutfitId = 130, BaseSpeed = 418, Speed = 418, SkillMagicLevel = 60, SkillFist = 10, SkillClub = 10, SkillSword = 10, SkillAxe = 10, SkillDistance = 10, SkillShield = 10, SkillFish = 10, Experience = 15694800, Level = 100, Mana = 2850, MaxMana = 2850, Soul = 100, Capacity = 139000, Stamina = 2520, Vocation = 4, SpawnX = 921, SpawnY = 771, SpawnZ = 6, TownX = 921, TownY = 771, TownZ = 6 },
                    new DbPlayer() { Id = 5, AccountId = 1, WorldId = 1, Name = "Druid", Health = 645, MaxHealth = 645, Direction = 2, BaseOutfitId = 130, OutfitId = 130, BaseSpeed = 418, Speed = 418, SkillMagicLevel = 60, SkillFist = 10, SkillClub = 10, SkillSword = 10, SkillAxe = 10, SkillDistance = 10, SkillShield = 10, SkillFish = 10, Experience = 15694800, Level = 100, Mana = 2850, MaxMana = 2850, Soul = 100, Capacity = 139000, Stamina = 2520, Vocation = 3, SpawnX = 921, SpawnY = 771, SpawnZ = 6, TownX = 921, TownY = 771, TownZ = 6 } );
