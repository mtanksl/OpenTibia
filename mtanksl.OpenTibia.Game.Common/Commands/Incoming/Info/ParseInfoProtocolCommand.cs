                ...
                if (Packet.RequestedInfo != RequestedInfo.None)
                {
                    XElement xml = new XElement("tsqp", 
                        ...
                        new XElement("rates",
                            ...
                            new XAttribute("skill", Context.Server.Config.GameplaySkillRate.ToString(CultureInfo.InvariantCulture) ),
                            new XAttribute("loot", Context.Server.Config.GameplayLootRate),
                            new XAttribute("magic", Context.Server.Config.GameplayMagicLevelRate.ToString(CultureInfo.InvariantCulture) ),
