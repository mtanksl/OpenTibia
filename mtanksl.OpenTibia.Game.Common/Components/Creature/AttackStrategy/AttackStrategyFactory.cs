...
namespace OpenTibia.Game.Components
{
    ...
    public static class AttackStrategyFactory
    {
        private static List<(string Name, AttackType Type, Func<int, int, IAttackStrategy> AttackStrategy)> items = new List<(string Name, AttackType Type, Func<int, int, IAttackStrategy> AttackStrategy)>()
        {
            ...
            ("death strike", AttackType.DeathStrike, (min, max) => new SpellBeamAttackStrategy(Offset.Beam1, MagicEffectType.MortArea, DamageType.Death, min, max) ),
            ...
            ("divine missile", AttackType.DivineMissile, (min, max) => new SpellBeamAttackStrategy(Offset.Beam1, MagicEffectType.HolyDamage, DamageType.Holy, min, max) ),
            ...
            ("energy strike", AttackType.EnergyStrike, (min, max) => new SpellBeamAttackStrategy(Offset.Beam1, MagicEffectType.EnergyArea, DamageType.Energy, min, max) ),
            ...
            ("flame strike", AttackType.FlameStrike, (min, max) => new SpellBeamAttackStrategy(Offset.Beam1, MagicEffectType.FireDamage, DamageType.Fire, min, max) ),
            ...
            ("ice strike", AttackType.IceStrike, (min, max) => new SpellBeamAttackStrategy(Offset.Beam1, MagicEffectType.IceDamage, DamageType.Ice, min, max) ),
            ...
            ("terra strike", AttackType.TerraStrike, (min, max) => new SpellBeamAttackStrategy(Offset.Beam1, MagicEffectType.Carniphilia, DamageType.Earth, min, max) ),
