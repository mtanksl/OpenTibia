...
{
    public class BerserkSpellPlugin : SpellPlugin
    {
        public BerserkSpellPlugin(Spell spell) : base(spell)
        {
        ...
        public override Promise OnCast(Player player, Creature target, string message, string parameter)
        {
            ...
            if (itemWeapon == null)
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetClientSkillLevel(Skill.Fist), 7);
            ...
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetClientSkillLevel(Skill.Sword), itemWeapon.Metadata.Attack.Value);
            ...
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetClientSkillLevel(Skill.Axe), itemWeapon.Metadata.Attack.Value);
            ...
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetClientSkillLevel(Skill.Club), itemWeapon.Metadata.Attack.Value);
