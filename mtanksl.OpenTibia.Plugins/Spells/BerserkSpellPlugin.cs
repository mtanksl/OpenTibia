...
namespace OpenTibia.Plugins.Spells
{
    public class BerserkSpellPlugin : SpellPlugin
    {
        ...
        public override Promise OnCast(Player player, Creature target, string message, string parameter)
        {
            ...
            if (itemWeapon == null)
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetSkillLevel(Skill.Fist), 7);
            ...
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetSkillLevel(Skill.Sword), itemWeapon.Metadata.Attack.Value);
            ...
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetSkillLevel(Skill.Axe), itemWeapon.Metadata.Attack.Value);
            ...
            {
                var formula = Formula.BerserkFormula(player.Level, player.Skills.GetSkillLevel(Skill.Club), itemWeapon.Metadata.Attack.Value);
