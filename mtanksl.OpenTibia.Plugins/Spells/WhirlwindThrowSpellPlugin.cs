...
namespace OpenTibia.Plugins.Spells
{
    public class WhirlwindThrowSpellPlugin : SpellPlugin
    {
        ...
        public override Promise OnCast(Player player, Creature target, string message)
        {
            ...
            {
                var formula = Formula.WhirlwindThrowFormula(player.Level, player.Skills.Sword, itemWeapon.Metadata.Attack.Value);
            ...
            {
                var formula = Formula.WhirlwindThrowFormula(player.Level, player.Skills.Axe, itemWeapon.Metadata.Attack.Value);
            ...
            {
                var formula = Formula.WhirlwindThrowFormula(player.Level, player.Skills.Club, itemWeapon.Metadata.Attack.Value);
