        ...
        public override Promise OnCast(Player player, Creature target, string message, string parameter)
        {
            ...
            if (itemWeapon.Metadata.WeaponType == WeaponType.Sword)
            {
                ...
                return Context.AddCommand(new CreatureAttackCreatureCommand(player, target,
                   ...
                   new DamageAttack(ProjectileType.WhirlWindSword, MagicEffectType.GroundShaker, DamageType.Physical, formula.Min, formula.Max, true) ) );
            }
            else if (itemWeapon.Metadata.WeaponType == WeaponType.Axe)
            {
                ...
                return Context.AddCommand(new CreatureAttackCreatureCommand(player, target,
                   ...
                   new DamageAttack(ProjectileType.WhirlWindAxe, MagicEffectType.GroundShaker, DamageType.Physical, formula.Min, formula.Max, true) ) );
            }
            else if (itemWeapon.Metadata.WeaponType == WeaponType.Club)
            {
                ...
                return Context.AddCommand(new CreatureAttackCreatureCommand(player, target,
                   ...
                   new DamageAttack(ProjectileType.WhirlWindClub, MagicEffectType.GroundShaker, DamageType.Physical, formula.Min, formula.Max, true) ) );
            }
            else
            {
