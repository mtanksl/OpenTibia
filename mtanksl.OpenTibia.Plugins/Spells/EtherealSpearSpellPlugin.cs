...
namespace OpenTibia.Plugins.Spells
{
    public class EtherealSpearSpellPlugin : SpellPlugin
    {
        ...
        {
            if (target != null && player.Tile.Position.IsInRange(target.Tile.Position, 5) && Context.Current.Server.Pathfinding.CanThrow(player.Tile.Position, target.Tile.Position) )
            {
