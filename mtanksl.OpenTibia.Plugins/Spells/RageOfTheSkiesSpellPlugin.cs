...
{
    public class RageOfTheSkiesSpellPlugin : SpellPlugin
    {
        public RageOfTheSkiesSpellPlugin(Spell spell) : base(spell)
        {
        ...
        public override Promise OnCast(Player player, Creature target, string message, string parameter)
        {
            ...
            var formula = Formula.GenericFormula(player.Level, player.Skills.GetClientSkillLevel(Skill.MagicLevel), 5, 0, 12, 0);
