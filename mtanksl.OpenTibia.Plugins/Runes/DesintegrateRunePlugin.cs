...
namespace OpenTibia.Plugins.Runes
{
    public class DesintegrateRunePlugin : RunePlugin
    {
        ...
        {
            if (toTile == null || toTile.Ground == null || toTile.TopItem == null || toTile.TopItem == rune || toTile.TopItem.Metadata.Flags.Is(ItemMetadataFlags.NotMoveable) || !player.Tile.Position.IsNextTo(toTile.Position) || (toTile.TopItem is Container container && container.Count > 0) || toTile.TopItem.UniqueId > 0)
            {
