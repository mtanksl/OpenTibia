...
{
    public abstract class BaseSpellBeamMonsterAttackPlugin : MonsterAttackPlugin
    {
        private Offset[] area;
        ...
        public BaseSpellBeamMonsterAttackPlugin(Offset[] area, MagicEffectType? magicEffectType, DamageType damageType)
        ...
        public BaseSpellBeamMonsterAttackPlugin(Offset[] area, MagicEffectType? magicEffectType, DamageType damageType, Condition condition)
        {
            this.area = area;
