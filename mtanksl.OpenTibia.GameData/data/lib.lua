...
attack = {
	damage = function(projectiletype, magiceffecttype, damagetype, min, max)
		return { type = "damage", projectiletype = projectiletype, magiceffecttype = magiceffecttype, damagetype = damagetype, min = min, max = max }
	end,
