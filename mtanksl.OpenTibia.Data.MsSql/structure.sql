...
VALUES (1, 1, CAST(0 AS bigint), 0, 0, 0, 0, 266, 0, 0, 2218, 139000, 2, CAST(15694800 AS bigint), 0, 645, CAST(0 AS bit), 100, 550, 645, 550, N'Gamemaster', 0, 0, 0, 0, 266, 0, 0, 2, 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 0, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 100, 921, 771, 6, 2218, 2520, 921, 771, 6, 0, 1),
(2, 1, CAST(0 AS bigint), 0, 0, 0, 0, 131, 0, 0, 418, 139000, 2, CAST(15694800 AS bigint), 0, 1565, CAST(0 AS bit), 100, 550, 1565, 550, N'Knight', 0, 0, 0, 0, 131, 0, 0, 0, 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 4, CAST(0 AS bigint), 80, CAST(0 AS bigint), 90, CAST(0 AS bigint), 100, 921, 771, 6, 418, 2520, 921, 771, 6, 1, 1),
(3, 1, CAST(0 AS bigint), 0, 0, 0, 0, 129, 0, 0, 418, 139000, 2, CAST(15694800 AS bigint), 0, 1105, CAST(0 AS bit), 100, 1470, 1105, 1470, N'Paladin', 0, 0, 0, 0, 129, 0, 0, 0, 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 70, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 15, CAST(0 AS bigint), 40, CAST(0 AS bigint), 10, CAST(0 AS bigint), 100, 921, 771, 6, 418, 2520, 921, 771, 6, 2, 1),
(4, 1, CAST(0 AS bigint), 0, 0, 0, 0, 130, 0, 0, 418, 139000, 2, CAST(15694800 AS bigint), 0, 645, CAST(0 AS bit), 100, 2850, 645, 2850, N'Sorcerer', 0, 0, 0, 0, 130, 0, 0, 0, 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 60, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 100, 921, 771, 6, 418, 2520, 921, 771, 6, 4, 1),
(5, 1, CAST(0 AS bigint), 0, 0, 0, 0, 130, 0, 0, 418, 139000, 2, CAST(15694800 AS bigint), 0, 645, CAST(0 AS bit), 100, 2850, 645, 2850, N'Druid', 0, 0, 0, 0, 130, 0, 0, 0, 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 60, CAST(0 AS bigint), 10, CAST(0 AS bigint), 10, CAST(0 AS bigint), 100, 921, 771, 6, 418, 2520, 921, 771, 6, 3, 1);
