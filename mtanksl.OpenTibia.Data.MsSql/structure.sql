...
CREATE TABLE [dbo].[Players](
	...
	[SkillMagicLevelTries] [bigint] NOT NULL,
	[SkillFist] [int] NOT NULL,
	[SkillFistTries] [bigint] NOT NULL,
	[SkillClub] [int] NOT NULL,
	[SkillClubTries] [bigint] NOT NULL,
	[SkillSword] [int] NOT NULL,
	[SkillSwordTries] [bigint] NOT NULL,
	[SkillAxe] [int] NOT NULL,
	[SkillAxeTries] [bigint] NOT NULL,
	[SkillDistance] [int] NOT NULL,
	[SkillDistanceTries] [bigint] NOT NULL,
	[SkillShield] [int] NOT NULL,
	[SkillShieldTries] [bigint] NOT NULL,
	[SkillFish] [int] NOT NULL,
	[SkillFishTries] [bigint] NOT NULL,
...
CREATE TABLE [dbo].[HouseItems](
	...
	[OpenTibiaId] [int] NOT NULL,
	[Count] [int] NOT NULL,
 CONSTRAINT [PK_HouseItems] PRIMARY KEY CLUSTERED 
(
	[HouseId] ASC,
	[SequenceId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
...
ALTER TABLE [dbo].[HouseItems]  WITH CHECK ADD  CONSTRAINT [FK_HouseItems_Houses_HouseId] FOREIGN KEY([HouseId])
REFERENCES [dbo].[Houses] ([Id])
ON DELETE CASCADE
GO
...
GO
INSERT [dbo].[Players] ([Id], [AccountId], [WorldId], [Name], [Health], [MaxHealth], [Direction], [BaseOutfitItemId], [BaseOutfitId], [BaseOutfitHead], [BaseOutfitBody], [BaseOutfitLegs], [BaseOutfitFeet], [BaseOutfitAddon], [OutfitItemId], [OutfitId], [OutfitHead], [OutfitBody], [OutfitLegs], [OutfitFeet], [OutfitAddon], [BaseSpeed], [Speed], [Invisible], [SkillMagicLevel], [SkillMagicLevelTries], [SkillFist], [SkillFistTries], [SkillClub], [SkillClubTries], [SkillSword], [SkillSwordTries], [SkillAxe], [SkillAxeTries], [SkillDistance], [SkillDistanceTries], [SkillShield], [SkillShieldTries], [SkillFish], [SkillFishTries], [Experience], [Level], [Mana], [MaxMana], [Soul], [Capacity], [Stamina], [Gender], [Vocation], [SpawnX], [SpawnY], [SpawnZ], [TownX], [TownY], [TownZ], [BankAccount]) VALUES (1, 1, 1, N'Gamemaster', 645, 645, 2, 0, 266, 0, 0, 0, 0, 0, 0, 266, 0, 0, 0, 0, 0, 2218, 2218, 0, 0, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 15694800, 100, 550, 550, 100, 139000, 2520, 0, 9, 921, 771, 6, 921, 771, 6, 0)
GO
INSERT [dbo].[Players] ([Id], [AccountId], [WorldId], [Name], [Health], [MaxHealth], [Direction], [BaseOutfitItemId], [BaseOutfitId], [BaseOutfitHead], [BaseOutfitBody], [BaseOutfitLegs], [BaseOutfitFeet], [BaseOutfitAddon], [OutfitItemId], [OutfitId], [OutfitHead], [OutfitBody], [OutfitLegs], [OutfitFeet], [OutfitAddon], [BaseSpeed], [Speed], [Invisible], [SkillMagicLevel], [SkillMagicLevelTries], [SkillFist], [SkillFistTries], [SkillClub], [SkillClubTries], [SkillSword], [SkillSwordTries], [SkillAxe], [SkillAxeTries], [SkillDistance], [SkillDistanceTries], [SkillShield], [SkillShieldTries], [SkillFish], [SkillFishTries], [Experience], [Level], [Mana], [MaxMana], [Soul], [Capacity], [Stamina], [Gender], [Vocation], [SpawnX], [SpawnY], [SpawnZ], [TownX], [TownY], [TownZ], [BankAccount]) VALUES (2, 1, 1, N'Knight', 1565, 1565, 2, 0, 131, 78, 69, 58, 76, 0, 0, 131, 78, 69, 58, 76, 0, 418, 418, 0, 4, 0, 10, 0, 10, 0, 90, 0, 10, 0, 10, 0, 80, 0, 10, 0, 15694800, 100, 550, 550, 100, 277000, 2520, 0, 1, 921, 771, 6, 921, 771, 6, 0)
GO
INSERT [dbo].[Players] ([Id], [AccountId], [WorldId], [Name], [Health], [MaxHealth], [Direction], [BaseOutfitItemId], [BaseOutfitId], [BaseOutfitHead], [BaseOutfitBody], [BaseOutfitLegs], [BaseOutfitFeet], [BaseOutfitAddon], [OutfitItemId], [OutfitId], [OutfitHead], [OutfitBody], [OutfitLegs], [OutfitFeet], [OutfitAddon], [BaseSpeed], [Speed], [Invisible], [SkillMagicLevel], [SkillMagicLevelTries], [SkillFist], [SkillFistTries], [SkillClub], [SkillClubTries], [SkillSword], [SkillSwordTries], [SkillAxe], [SkillAxeTries], [SkillDistance], [SkillDistanceTries], [SkillShield], [SkillShieldTries], [SkillFish], [SkillFishTries], [Experience], [Level], [Mana], [MaxMana], [Soul], [Capacity], [Stamina], [Gender], [Vocation], [SpawnX], [SpawnY], [SpawnZ], [TownX], [TownY], [TownZ], [BankAccount]) VALUES (3, 1, 1, N'Paladin', 1105, 1105, 2, 0, 129, 78, 69, 58, 76, 0, 0, 129, 78, 69, 58, 76, 0, 418, 418, 0, 20, 0, 10, 0, 10, 0, 10, 0, 10, 0, 70, 0, 40, 0, 10, 0, 15694800, 100, 1470, 1470, 100, 231000, 2520, 0, 2, 921, 771, 6, 921, 771, 6, 0)
GO
INSERT [dbo].[Players] ([Id], [AccountId], [WorldId], [Name], [Health], [MaxHealth], [Direction], [BaseOutfitItemId], [BaseOutfitId], [BaseOutfitHead], [BaseOutfitBody], [BaseOutfitLegs], [BaseOutfitFeet], [BaseOutfitAddon], [OutfitItemId], [OutfitId], [OutfitHead], [OutfitBody], [OutfitLegs], [OutfitFeet], [OutfitAddon], [BaseSpeed], [Speed], [Invisible], [SkillMagicLevel], [SkillMagicLevelTries], [SkillFist], [SkillFistTries], [SkillClub], [SkillClubTries], [SkillSword], [SkillSwordTries], [SkillAxe], [SkillAxeTries], [SkillDistance], [SkillDistanceTries], [SkillShield], [SkillShieldTries], [SkillFish], [SkillFishTries], [Experience], [Level], [Mana], [MaxMana], [Soul], [Capacity], [Stamina], [Gender], [Vocation], [SpawnX], [SpawnY], [SpawnZ], [TownX], [TownY], [TownZ], [BankAccount]) VALUES (4, 1, 1, N'Sorcerer', 645, 645, 2, 0, 130, 78, 69, 58, 76, 0, 0, 130, 78, 69, 58, 76, 0, 418, 418, 0, 70, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 15694800, 100, 2850, 2850, 100, 139000, 2520, 0, 4, 921, 771, 6, 921, 771, 6, 0)
GO
INSERT [dbo].[Players] ([Id], [AccountId], [WorldId], [Name], [Health], [MaxHealth], [Direction], [BaseOutfitItemId], [BaseOutfitId], [BaseOutfitHead], [BaseOutfitBody], [BaseOutfitLegs], [BaseOutfitFeet], [BaseOutfitAddon], [OutfitItemId], [OutfitId], [OutfitHead], [OutfitBody], [OutfitLegs], [OutfitFeet], [OutfitAddon], [BaseSpeed], [Speed], [Invisible], [SkillMagicLevel], [SkillMagicLevelTries], [SkillFist], [SkillFistTries], [SkillClub], [SkillClubTries], [SkillSword], [SkillSwordTries], [SkillAxe], [SkillAxeTries], [SkillDistance], [SkillDistanceTries], [SkillShield], [SkillShieldTries], [SkillFish], [SkillFishTries], [Experience], [Level], [Mana], [MaxMana], [Soul], [Capacity], [Stamina], [Gender], [Vocation], [SpawnX], [SpawnY], [SpawnZ], [TownX], [TownY], [TownZ], [BankAccount]) VALUES (5, 1, 1, N'Druid', 645, 645, 2, 0, 130, 78, 69, 58, 76, 0, 0, 130, 78, 69, 58, 76, 0, 418, 418, 0, 70, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 10, 0, 15694800, 100, 2850, 2850, 100, 139000, 2520, 0, 3, 921, 771, 6, 921, 771, 6, 0)
GO
