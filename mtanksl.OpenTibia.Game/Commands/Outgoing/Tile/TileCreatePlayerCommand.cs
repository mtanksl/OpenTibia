...
namespace OpenTibia.Game.Commands
{
    public class TileCreatePlayerCommand : CommandResult<Player>
    {
        ...
        private static void LoadInventory(Context context, Player player, OpenTibia.Data.Models.Player databasePlayer)
        {
        ...
        private static void LoadVip(Player player, OpenTibia.Data.Models.Player databasePlayer)
        {
