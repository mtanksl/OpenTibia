    ...
    public class CreatureWalkToCommand : IncomingCommand
    {
        ...
        public override async Promise Execute()
        {
            ...
            for (int i = 0; i < moveDirections.Length; i++)
            {
                ...
                await Context.Server.GameObjectComponents.AddComponent(Creature, new CreatureWalkDelayBehaviour(TimeSpan.FromMilliseconds(diagonalCost * 1000 * toTile.Ground.Metadata.Speed / Creature.Speed) ) ).Promise;
