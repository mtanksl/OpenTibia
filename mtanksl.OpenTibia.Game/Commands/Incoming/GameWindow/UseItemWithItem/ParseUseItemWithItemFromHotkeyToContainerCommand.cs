...
namespace OpenTibia.Game.Commands
{
    ...
    {
        public ParseUseItemWithItemFromHotkeyToContainerCommand(Player player, ushort fromTibiaId, byte toContainerId, byte toContainerIndex, ushort toTibiaId) :base(player)
        {
