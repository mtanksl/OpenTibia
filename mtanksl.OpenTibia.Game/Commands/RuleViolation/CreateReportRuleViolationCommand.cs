    ...
    public class CreateReportRuleViolationCommand : Command
    {
        ...
        public override void Execute(Server server, CommandContext context)
        {
            ...
            if (ruleViolation == null)
            {
                ...
                {
                    context.Write(observer.Client.Connection, new ShowText(0, ruleViolation.Reporter.Name, ruleViolation.Reporter.Level, TalkType.ReportRuleViolationOpen, ruleViolation.Time, ruleViolation.Message) );
                }
            }
        }
    }
