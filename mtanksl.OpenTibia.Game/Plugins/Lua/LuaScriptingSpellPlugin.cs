...
namespace OpenTibia.Game.Components
{
    public class LuaScriptingSpellPlugin : SpellPlugin
    {
        ...
        {
            script = Context.Server.LuaScripts.Create(Context.Server.PathResolver.GetFullPath("data/lib.lua"), Context.Server.PathResolver.GetFullPath("data/plugins/lib.lua"), Context.Server.PathResolver.GetFullPath("data/plugins/spells/lib.lua"), Context.Server.PathResolver.GetFullPath(fileName) );
        }
