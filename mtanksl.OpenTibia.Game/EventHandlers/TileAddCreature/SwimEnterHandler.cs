        ...
        public override Promise Handle(TileAddCreatureEventArgs e)
        {
            ...
            if (fromTile == null && toTile != null)
            {
                if (toTile.Ground != null)
                {
                    ...
                    {
                        return Context.AddCommand(new CreatureUpdateOutfitCommand(e.Creature, e.Creature.BaseOutfit, e.Creature.ConditionOutfit, true, e.Creature.ConditionStealth, e.Creature.ItemStealth, e.Creature.IsMounted) ).Then( () =>
                        {
