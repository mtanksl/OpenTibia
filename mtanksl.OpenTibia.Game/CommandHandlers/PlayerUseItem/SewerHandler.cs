...
namespace OpenTibia.Game.CommandHandlers
{
    public class SewerHandler : CommandHandler<PlayerUseItemCommand>
    {
        ...
        public override Promise Handle(Func<Promise> next, PlayerUseItemCommand command)
        {
            ...
            {
                return Context.AddCommand(new CreatureUpdateTileCommand(command.Player, Context.Server.Map.GetTile( ( (Tile)command.Item.Parent ).Position.Offset(0, 0, 1) ), Direction.South) );
            }
