...
namespace OpenTibia.Game.GameObjectScripts
{
    public class PlayerScript : GameObjectScript<string, Player>
    {
        ...
        {
            Context.Server.GameObjectComponents.AddComponent(player, new PlayerThinkBehaviour(new MeleeAttackStrategy(null, null, TimeSpan.FromMilliseconds(500) ), new FollowWalkStrategy() ) );
