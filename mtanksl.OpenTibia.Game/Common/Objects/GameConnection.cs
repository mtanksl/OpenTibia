...
namespace OpenTibia.Common
{
    public class GameConnection : RateLimitingConnection
    {
        ...
        private static Dictionary<byte, IPacketToCommand> accountManagerCommands = new Dictionary<byte, IPacketToCommand>();
        ...
        static GameConnection()
		{
			...
			accountManagerCommands.Add(0x14, new PacketToCommand<LogOutIncomingPacket>("Log Out", (connection, packet) => new ParseLogOutCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x1E, new PacketToCommand<PongIncomingPacket>("Pong", (connection, packet) => new ParsePongCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x64, new PacketToCommand<WalkToIncomingPacket>("Walk To", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x65, new PacketToCommand<WalkNorthIncomingPacket>("Walk North", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x66, new PacketToCommand<WalkEastIncomingPacket>("Walk East", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x67, new PacketToCommand<WalkSouthIncomingPacket>("Walk South", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x68, new PacketToCommand<WalkWestIncomingPacket>("Walk West", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x69, new PacketToCommand<StopWalkIncomingPacket>("Stop Walk", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x6A, new PacketToCommand<WalkNorthEastIncomingPacket>("Walk North East", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x6B, new PacketToCommand<WalkSouthEastIncomingPacket>("Walk South East", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x6C, new PacketToCommand<WalkSouthWestIncomingPacket>("Walk South West", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x6D, new PacketToCommand<WalkNorthWestIncomingPacket>("Walk North West", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x6F, new PacketToCommand<TurnNorthIncomingPacket>("Turn North", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x70, new PacketToCommand<TurnEastIncomingPacket>("Turn East", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x71, new PacketToCommand<TurnSouthIncomingPacketh>("Turn South", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x72, new PacketToCommand<TurnWestIncomingPacket>("Turn West", (connection, packet) => new DisallowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x78, new PacketToCommand<MoveItemIncomingPacket>("Move Item", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x79, new PacketToCommand<LookItemNpcTradeIncomingPacket>("Look Item Npc Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x7A, new PacketToCommand<BuyNpcTradeIncomingPacket>("Buy Npc Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x7B, new PacketToCommand<SellNpcTradeIncomingPacket>("Sell Npc Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x7C, new PacketToCommand<CloseNpcTradeIncomingPacket>("Close Npc Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x7D, new PacketToCommand<TradeWithIncomingPacket>("Trade With", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x7E, new PacketToCommand<LookItemTradeIncomingPacket>("Look Item Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x7F, new PacketToCommand<AcceptTradeIncomingPacket>("Accept Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x80, new PacketToCommand<CancelOrRejectTradeIncomingPacket>("Cancel Or Reject Trade", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x82, new PacketToCommand<UseItemIncomingPacket>("Use Item", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x83, new PacketToCommand<UseItemWithItemIncomingPacket>("Use Item With Item", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x84, new PacketToCommand<UseItemWithCreatureIncomingPacket>("Use Item With Creature", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x85, new PacketToCommand<RotateItemIncomingPacket>("Rotate Item", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x87, new PacketToCommand<CloseContainerIncomingPacket>("Close Container", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x88, new PacketToCommand<OpenParentContainerIncomingPacket>("Open Parent Container", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x89, new PacketToCommand<EditTextDialogIncomingPacket>("Edit Text Dialog", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x8A, new PacketToCommand<EditListDialogIncomingPacket>("Edit List Dialog", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
			...
			accountManagerCommands.Add(0x98, new PacketToCommand<OpenedNewChannelIncomingPacket>("Opened New Channel", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x99, new PacketToCommand<CloseChannelIncomingPacket>("Close Channel", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x9A, new PacketToCommand<OpenedPrivateChannelIncomingPacket>("Opened Private Channel", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x9B, new PacketToCommand<ProcessReportRuleViolationIncomingPacket>("Process Report Rule Violation", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x9C, new PacketToCommand<CloseReportRuleViolationChannelAnswerIncomingPacket>("Close Report Rule Violation Channel Answer", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x9D, new PacketToCommand<CloseReportRuleViolationChannelQuestionIncomingPacket>("Close Report Rule Violation Channel Question", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0x9E, new PacketToCommand<CloseNpcsChannelIncomingPacket>("Close Npcs Channel", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA0, new PacketToCommand<CombatControlsIncomingPacket>("Combat Controls", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA1, new PacketToCommand<AttackIncomingPacket>("Attack", (connection, packet) => new ParseStopAttackCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA2, new PacketToCommand<FollowIncomingPacket>("Follow", (connection, packet) => new ParseStopFollowCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA3, new PacketToCommand<InviteToPartyIncomingPacket>("Invite To Party", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA4, new PacketToCommand<JoinPartyIncomingPacket>("Join Party", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA5, new PacketToCommand<RevokePartyIncomingPacket>("Revoke Party", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA6, new PacketToCommand<PassLeadershipToIncomingPacket>("Pass Leadership To", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA7, new PacketToCommand<LeavePartyIncomingPacket>("Leave Party", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xA8, new PacketToCommand<SharedExperienceIncomingPacket>("Shared Experience", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xAA, new PacketToCommand<OpenedMyPrivateChannelIncomingPacket>("Opened My Private Channel", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xAB, new PacketToCommand<InvitePlayerIncomingPacket>("Invite Player", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xAC, new PacketToCommand<ExcludePlayerIncomingPacket>("Exclude Player", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xBE, new PacketToCommand<StopIncomingPacket>("Stop", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			// 0xC9 - Update Tile
            
			// 0xCA - Update Container
            
			accountManagerCommands.Add(0xD2, new PacketToCommand<SetOutfitIncomingPacket>("Set Outfit", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xD3, new PacketToCommand<SelectedOutfitIncomingPacket>("Selected Outfit", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xDC, new PacketToCommand<AddVipIncomingPacket>("Add Vip", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xDD, new PacketToCommand<RemoveVipIncomingPacket>("Remove Vip", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xE6, new PacketToCommand<ReportBugIncomingPacket>("Report Bug", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
			
			accountManagerCommands.Add(0xE8, new PacketToCommand<DebugAssertIncomingPacket>("Debug Assert", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
			
			accountManagerCommands.Add(0xF0, new PacketToCommand<QuestsIncomingPacket>("Quests", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
            
			accountManagerCommands.Add(0xF1, new PacketToCommand<OpenQuestIncomingPacket>("Open Quest", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
			
			accountManagerCommands.Add(0xF2, new PacketToCommand<ReportRuleViolationIncomingPacket>("Report Rule Violation", (connection, packet) => new IgnoreCommand(connection.Client.Player) ) );
		}
