...
namespace OpenTibia
{
    public class Message
    {
        ...
        public Message Write(IOutgoingPacket packet)
        {
            packets.Add(packet);
        ...
        public Message Write(params IOutgoingPacket[] packet)
        {
        ...
        private byte[] Encript(uint[] keys, byte[] bytes)
        {
        ...
        public byte[] GetBytes(uint[] keys)
        {
            ...
            return Length(Hash(Encript(keys, Length(stream.GetBytes()))));
        }
    }
}