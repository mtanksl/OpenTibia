...
namespace OpenTibia
{
    public class SkillsOutgoingPacket : IOutgoingPacket
    {
        public SkillsOutgoingPacket(byte fist, byte fistPercent, byte club, byte clubPercent, byte sword, byte swordPercent, byte axe, byte axePercent, byte distance, byte distancePercent, byte shield, byte shieldPercent, byte fish, byte fishPercent)
        {
            this.Fist = fist;
