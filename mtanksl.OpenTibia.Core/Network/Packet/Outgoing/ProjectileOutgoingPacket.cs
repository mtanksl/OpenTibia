...
namespace OpenTibia
{
    public class ProjectileOutgoingPacket : IOutgoingPacket
    {
        public ProjectileOutgoingPacket(Position fromPosition, Position toPosition, ProjectileType projectileType)
        {
